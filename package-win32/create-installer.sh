...
if [ -d "C:" ] ; then 
	...
	echo manage perl dependencies;
	perl generate_perl_deps.pl

	if [ ! -d $script_dir/perl ] ; then
		echo MISSING FOLDER: $script_dir/perl;
		echo "This folder should be generated by $script_dir/generate_perl_deps.pl ..."
		exit 1;
	fi
	...
	echo TODO: create debian package;
fi
